...
from CompareDistributionsHelpers import *
from TopSamples import files, ranges
...
basepath = '/uscms/home/camclean/nobackup/CMSSW_8_0_13/src/TopTagging/tthbb13/2016Ana/test/run20161118/'
...
fits["zprime_m2000_1p"]     = ROOT.TF1("fit_fun_zprime","pol5",801,999)
...
for qcd_name in  ["qcd_800_1000"]: #["qcd_300_470_topSize", "qcd_600_800_topSize"]: #["qcd_600_800_topSize", "qcd_800_1000_topSize", "qcd_1000_1400_topSize"]: #["qcd_800_1000"]: #["qcd_170_300", "qcd_300_470", "qcd_470_600", "qcd_800_1000"]:
...
output_pickle_file_name = "/uscms_data/d3/camclean/CMSSW_8_0_13/src/TopTagging/tthbb13/2016Ana/Plotting/python/gregor/flat_pt_weights.pickle"
...
if True:    
    for k in to_process:
        ...
        combinedPlot ( k + "_pt_cut",
                       [plot( k, 
                              "pt",
                              '((pt>{0})&&(pt<{1}))'.format(ranges[k][0], ranges[k][1]), 
                              k,
                              fit=fits[k]
                              ), 
                        ],
